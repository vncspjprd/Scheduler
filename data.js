...
const SCHEDULE_TEMPLATES = {
  heavy_laundry: {
    ...
    blocks: [
      ...
      { time: "1:30 - 2:30 PM", label: "Lunch break", cls: "tag-free" },
      { time: "2:30 - 4:00 PM", label: "Data Analytics course module", cls: "tag-course" },
      { time: "4:00 - 4:30 PM", label: "Break", cls: "tag-free" },
      { time: "4:30 - 6:00 PM", label: "Civil service review - drills", cls: "tag-review" },
      { time: "6:00 - 7:00 PM", label: "Free time / rest", cls: "tag-free" },
      { time: "7:00 - 8:00 PM", label: "Light reading / personal dev", cls: "tag-personal" },
      { time: "8:00 - 11:00 PM", label: "Wind down", cls: "tag-free" },
    ],
  ...
  no_laundry: {
    ...
    blocks: [
      ...
      { time: "12:30 - 1:30 PM", label: "Lunch break", cls: "tag-free" },
      { time: "1:30 - 3:30 PM", label: "Civil service review - grammar & language", cls: "tag-review" },
      { time: "3:30 - 4:00 PM", label: "Merienda / break", cls: "tag-free" },
      { time: "4:00 - 5:30 PM", label: "Civil service review - math & logic drills", cls: "tag-review" },
      { time: "5:30 - 7:00 PM", label: "Free time / rest", cls: "tag-free" },
      { time: "7:00 - 8:00 PM", label: "Light reading / personal dev", cls: "tag-personal" },
      { time: "8:00 - 11:00 PM", label: "Wind down", cls: "tag-free" },
    ],
    ...
    modes: {
      heavy_laundry: {
        blocks: [
          ...
          { time: "2:30 - 4:00 PM", label: "Data Analytics course module", cls: "tag-course" },
          { time: "4:00 - 4:30 PM", label: "Break", cls: "tag-free" },
          { time: "4:30 - 6:00 PM", label: "Civil service review - math & logic drills", cls: "tag-review" },
          { time: "6:00 - 7:00 PM", label: "Free time / rest", cls: "tag-free" },
          { time: "7:00 - 8:00 PM", label: "Light reading / personal dev", cls: "tag-personal" },
          { time: "8:00 - 11:00 PM", label: "Wind down", cls: "tag-free" },
        ],
      ...
      light_laundry: {
        blocks: [
          ...
          { time: "2:30 - 3:00 PM", label: "Break", cls: "tag-free" },
          { time: "3:00 - 5:00 PM", label: "Civil service review - math & logic drills", cls: "tag-review" },
    ...
    modes: {
      heavy_laundry: {
        blocks: [
          ...
          { time: "1:30 - 2:30 PM", label: "Lunch break", cls: "tag-free" },
          { time: "2:30 - 4:00 PM", label: "Data Analytics course module", cls: "tag-course" },
          { time: "4:00 - 5:30 PM", label: "Civil service review - drills", cls: "tag-review" },
          { time: "5:30 - 7:00 PM", label: "Free time / rest", cls: "tag-free" },
          { time: "7:00 - 8:00 PM", label: "Light reading / personal dev", cls: "tag-personal" },
          { time: "8:00 - 11:00 PM", label: "Wind down", cls: "tag-free" },
        ],
      ...
      light_laundry: {
        blocks: [
          ...
          { time: "10:00 AM - 12:00 PM", label: "Civil service review - verbal & reading comp", cls: "tag-review" },
          { time: "12:00 - 1:00 PM", label: "Lunch break", cls: "tag-free" },
          { time: "1:00 - 2:45 PM", label: "Data Analytics course module", cls: "tag-course" },
          { time: "2:45 - 3:15 PM", label: "Merienda / break", cls: "tag-free" },
          { time: "3:15 - 4:45 PM", label: "Civil service review - math & logic drills", cls: "tag-review" },
          { time: "4:45 - 7:00 PM", label: "Free time / rest", cls: "tag-free" },
          { time: "7:00 - 8:00 PM", label: "Light reading / personal dev", cls: "tag-personal" },
          { time: "8:00 - 11:00 PM", label: "Wind down", cls: "tag-free" },
        ],
    ...
    modes: {
      heavy_laundry: {
        blocks: [
          ...
          { time: "1:30 - 2:30 PM", label: "Lunch break", cls: "tag-free" },
          { time: "2:30 - 4:00 PM", label: "Data Analytics course module", cls: "tag-course" },
          { time: "4:00 - 5:00 PM", label: "Civil service review - drills", cls: "tag-review" },
      ...
      no_laundry: {
        blocks: [
          ...
          { time: "10:45 AM - 12:30 PM", label: "Data Analytics course module", cls: "tag-course" },
          { time: "12:30 - 1:30 PM", label: "Lunch break", cls: "tag-free" },
          { time: "1:30 - 3:30 PM", label: "Civil service review", cls: "tag-review" },
          { time: "3:30 - 5:00 PM", label: "Civil service review - drills / practice test", cls: "tag-review" },
          { time: "5:00 PM onwards", label: "Church duties / unavailable", cls: "tag-church" },
        ],
    ...
    modes: {
      heavy_laundry: {
        blocks: [
          ...
          { time: "1:00 - 2:00 PM", label: "Lunch break", cls: "tag-free" },
          { time: "2:00 - 3:30 PM", label: "Data Analytics course module", cls: "tag-course" },
